...
const schema=z.object({
 name:z.string().min(2).optional(),legal_name:z.string().nullable().optional(),cnpj:z.string().nullable().optional(),city:z.string().nullable().optional(),state:z.string().nullable().optional(),phone:z.string().nullable().optional(),whatsapp:z.string().nullable().optional(),email:z.union([z.string().email(),z.literal(''),z.null()]).optional(),seller_id:z.string().uuid().nullable().optional(),payment_terms:z.string().nullable().optional(),credit_limit:z.coerce.number().min(0).optional(),region:z.string().nullable().optional(),notes:z.string().nullable().optional(),active:z.boolean().optional(),postal_code:z.string().nullable().optional(),street:z.string().nullable().optional(),street_number:z.string().nullable().optional(),address_complement:z.string().nullable().optional(),neighborhood:z.string().nullable().optional(),latitude:z.coerce.number().min(-90).max(90).nullable().optional(),longitude:z.coerce.number().min(-180).max(180).nullable().optional(),visit_radius_meters:z.coerce.number().min(50).max(10000).optional()
});
